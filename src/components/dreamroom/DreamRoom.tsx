  ...
  return (
    <div className="relative min-h-screen overflow-hidden" style={{
      ...
      <div className="relative z-10 flex flex-col items-center min-h-screen">
        ...
        <div className="w-full max-w-lg mx-auto px-3 flex-1 flex flex-col pb-28 md:pb-24eight: 0 }}>
          {/* Toggle chat */}
          ...
          {showChat && (
            <div ref={chatScrollRef}
              className="flex-1 overflow-y-auto spac0e-y-2 px-1 pb-e-y-2 px-1 pb-20crollbar-thin"
              style={{
